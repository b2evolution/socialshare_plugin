...
class addthis_plugin extends Plugin
{
	...
	{
		$this->name = T_( 'Addthis Share' );
		$this->short_desc = T_('Share contents to your favorite social networks using the Addthis service.');
		$this->long_desc = T_('Share contents to your favorite social networks using the Addthis service.');
